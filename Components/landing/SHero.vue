<template>
  <div class="">
    <div
      class="w-full max-w-custom mx-auto flex items-center justify-between py-3 xl:px-12 max-[375px]:px-2 px-4 xl:py-2 max-[1279px]:px-4 sm:py-8"
    >
      <div
        class="flex flex-col w-full md:w-2/5 justify-center text-center md:text-left xl:pt-20z xl:px-0 px-1"
      >
        <h1
...
<style>
@media (min-width: 1284px) and (max-width: 1553px) {
  .size-responsive {
    font-size: 48px;
  }
}
