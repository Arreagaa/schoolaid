<template>
  <div class="flex flex-col lg:flex-row">
    <div class="lg:order-1 order-2 lg:w-1/2">
      <div
        class="PoppinsLight min-[1535px]:px-24 px-8 py-4 pb-10 font-bold text-xl"
      >
      ...
      <div
        class="flex flex-col bg-[#537FF7] PoppinsLight min-[1535px]:px-24 px-8 py-16 lg:pb-72 text-xl text-white"
      >
