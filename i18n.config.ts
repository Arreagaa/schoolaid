export default defineI18nConfig(() => ({
  ...
  messages: {
    es: {
      ...
      Contacto: "Contacto",
      Idioma: "Idioma",
      "Simplificamos procesos": "Simplificamos procesos",
      "mejoramos relaciones": "mejoramos relaciones",
      "Automatiza y simplifica los procesos diarios entre colegio y padres de familia.":
        "Automatiza y simplifica los procesos diarios entre colegio y padres de familia.",
      "Conoce más": "Conoce más",
      "¡Nuevo socio de integración!": "¡Nuevo socio de integración!",
      ...
      "Gestión de visitantes, seguridad, control y seguridad de los alumnos.":
        "Gestión de visitantes, seguridad, control y seguridad de los alumnos.",
      "Automatizar operaciones": "Automatizar operaciones",
      "Asistencia, solicitudes de los padres y cambios de horario.":
        "Asistencia, solicitudes de los padres y cambios de horario.",
      ...
      "Personaliza el punto de venta según tus necesidades.":
        "Personaliza el punto de venta según tus necesidades.",
      community_text: "Puedes utilizar SchoolAid en cualquier parte del mundo",
    ...
    en: {
      ...
      Contacto: "Contact",
      Idioma: "Language",
      "Simplificamos procesos": "School operations",
      "mejoramos relaciones": "made simple",
      "Automatiza y simplifica los procesos diarios entre colegio y padres de familia.":
      ...
      "Gestión de visitantes, seguridad, control y seguridad de los alumnos.":
        "Visitor management, security, control and student safety.",
      "Automatizar operaciones": "Automate operations",
      "Asistencia, solicitudes de los padres y cambios de horario.":
        "Attendance, parent requests, and schedule changes.",
      Transporte: "Transportation",
      Comunicación: "Comunication",
      "Gestión de pasajeros, automatización, seguimiento y trazabilidad en tiempo real.":
        "Bus ridership management, carline automation, real-time tracking and traceability.",
      "Centro de chat y herramientas de comunicación eficientes e inmediatas.":
      ...
      "Mantén el control de los accesos, salidas y cambios. Administra solicitudes de padres y asistencia en clases.":
        "Manage parent requests, access and dismissal control, visitor management, and more.",
      "Centraliza todas las herramientas y la comunicación en un solo lugar.":
        "Centralize all communication, send messages and notifications to parents, and more.",
      "Atención a padres a través de chat. Crea y administra canales de servicio al cliente.":
        "Customer service through personalized chat channels.",
      "Crea encuestas y formularios personalizados. Administra registros médicos y más.":
      ...
      community_text: "You can use SchoolAid anywhere in the world",
      ...
      "Envíanos tus datos para asesorarte con la mejor solución para ti":
        "Leave your information and we'll reach out to you.",
      Nombre: "Name",
      Apellido: "Surname",
